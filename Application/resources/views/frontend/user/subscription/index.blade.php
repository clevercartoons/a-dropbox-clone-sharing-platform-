                ...
                <div class="vr__counter__box white h-100">
                    ...
                    @if (!subscription()->plan->is_free)
                        <form class="d-inline me-2"
                            ...
                            @csrf
                            <button class="vr__confirm__action__form btn btn-primary btn-sm"><i
                ...
                <div class="custom-list card">
                    ...
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            ...
                            <span>{{ subscription()->plan->interval_name }}</span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center">
            ...
            <div class="vr__table">
                <table>
                    <thead>
                        ...
                        <th class="text-center">{{ lang('Total Price', 'user') }}</th>
                        ...
                        @foreach ($transactions as $transaction)
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    ({{ !$transaction->plan->interval ? lang('Monthly', 'plans') : lang('Yearly', 'plans') }})
                                </td>
                                <td class="text-center">
                                    {{ priceSymbol($transaction->plan_price) }}
                                </td>
                                <td class="text-center">
