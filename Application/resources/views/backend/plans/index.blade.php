                ...
                <table id="datatable" class="table w-100">
                    <thead>
                        <tr>
                            ...
                            <th class="tb-w-7x">{{ __('Plan name') }}</th>
                            ...
                            <tr class="item">
                                ...
                                <td>
                                    @if ($yearlyPlan->transfer_interval == 1)
                                        {{ $yearlyPlan->transfer_interval == null ? __('Unlimited') : $yearlyPlan->transfer_interval . ' ' . __('Day') }}
                                    @else
                                        {{ $yearlyPlan->transfer_interval == null ? __('Unlimited') : $yearlyPlan->transfer_interval . ' ' . __('Days') }}
                                    @endif
                                </td>
                                <td>
                                    <strong>
