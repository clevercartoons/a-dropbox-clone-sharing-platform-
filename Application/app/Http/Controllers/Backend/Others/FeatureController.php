...
class FeatureController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $uploadImage = vImageUpload($request->file('image'), 'images/others/features/', '500x280');
        if ($uploadImage) {
    ...
    public function update(Request $request, Feature $feature)
    {
        ...
        if ($request->has('image')) {
            $uploadImage = vImageUpload($request->file('image'), 'images/others/features/', '500x280', null, $feature->image);
        } else {
