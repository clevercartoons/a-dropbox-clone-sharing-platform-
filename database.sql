...
--
-- Host: localhost:3306
-- Generation Time: Apr 14, 2022 at 03:10 AM
...
(1, 'Swipgle', 'Swipgle', 'admin@vironeer.com', 'images/avatars/default.png', '$2y$10$6bHcj64QAi6wd8BFKjJR.uA1EiLHm.tNXYv0WcYGTYovbuQFSlDq.', NULL, '2022-04-13 23:00:49', '2022-04-13 23:00:49');
...
(1, 'Google reCAPTCHA', 'google_recaptcha', 'images/extensions/google-recaptcha.png', '{\"site_key\":null,\"secret_key\":null}', NULL, 0, '2022-02-23 20:40:12', '2022-04-11 01:06:26'),
...
(88, '2022_01_06_225055_create_features_table', 33),
...
(107, '2022_03_04_205910_create_transactions_table', 43),
(109, '2022_03_07_231527_create_taxes_table', 44),
(110, '2022_03_18_001216_create_uploads_table', 45),
(113, '2022_03_22_210123_create_transfer_files_table', 47),
(114, '2022_03_27_213347_create_ratings_table', 48),
...
INSERT INTO `payment_gateways` (`id`, `name`, `symbol`, `handler`, `logo`, `fees`, `test_mode`, `credentials`, `instructions`, `status`, `created_at`, `updated_at`) VALUES
(1, 'Paypal', 'paypal_express', 'App\\Http\\Controllers\\Frontend\\Gateways\\PaypalExpressController', 'images/payments/l6yGIXyP6SbqTrA_1641691269.png', 0, 0, '{\"client_id\":null,\"client_secret\":null}', '<ul class=\"mb-0\"> \r\n<li>You can get the Api Keys from : <a target=\"__blank\" href=\"https://developer.paypal.com/developer/applications/create\">https://developer.paypal.com/developer/applications/create</a>&nbsp;</li> \r\n</ul>', 0, '2022-01-08 21:05:29', '2022-04-11 02:08:18'),
(2, 'Stripe', 'stripe_checkout', 'App\\Http\\Controllers\\Frontend\\Gateways\\StripeCheckoutController', 'images/payments/uvoikzLBtydhsIQ_1646689633.png', 0, NULL, '{\"publishable_key\":null,\"secret_key\":null}', '<ul class=\"mb-0\"> <li>You can get the API keys from : <a target=\"__blank\" href=\"https://dashboard.stripe.com/apikeys\">https://dashboard.stripe.com/apikeys</a>&nbsp;</li>\r\n</ul>', 0, '2022-01-08 21:05:29', '2022-04-11 02:08:26');
...
CREATE TABLE `plans` (
  ...
  `interval` tinyint(1) NOT NULL COMMENT '0:Monthly 1:Yearly',
...
(1, 'website_name', 'Swipgle - Easy File Transfer'),
(2, 'website_url', 'https://demo.belovevn.com'),
...
(41, 'website_home_background', 'images/6JmgzKWhU4mQ3zd.jpg'),
(42, 'website_uploadbtn_dark_color', '#5BBC2E'),
(43, 'website_uploadbtn_medium_color', '#82DD58'),
(44, 'website_uploadbtn_light_color', '#9FE280'),
...
(52, 'statistics_download_files', NULL),
(53, 'statistics_send_files', NULL),
(54, 'statistics_total_transfers', NULL),
(55, 'website_tickets_status', '1'),
(56, 'website_mail_logo', 'images/mail-logo.png'),
...
(2, 'Amazon S3', 's3', 'App\\Http\\Controllers\\Frontend\\Storage\\AmazonController', 'images/storage/amazon.png', '{\"access_key_id\":null,\"secret_access_key\":null,\"default_region\":null,\"bucket\":null,\"url\":null}', NULL, 0, '2022-02-20 22:12:55', '2022-04-07 04:39:51');
...
CREATE TABLE `transactions` (
  ...
  `status` tinyint(4) NOT NULL DEFAULT 0 COMMENT '1:Paid 2:Canceled',
...
(3957, 'en', 'home page', 'Features', 'Features', '2022-02-26 22:12:42', '2022-02-26 22:12:42'),
(3958, 'en', 'home page', 'Features description', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s.', '2022-02-26 22:13:29', '2022-02-26 22:13:44'),
(3959, 'en', 'home page', 'Pricing', 'Pricing', '2022-02-26 22:14:42', '2022-03-29 02:41:22'),
(3960, 'en', 'home page', 'Pricing description', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s.', '2022-02-26 22:14:42', '2022-02-26 22:14:49'),
(3961, 'en', 'home page', 'Blog', 'Blog', '2022-02-26 22:15:28', '2022-02-26 22:15:28'),
(3962, 'en', 'home page', 'Blog description', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s.', '2022-02-26 22:15:28', '2022-02-26 22:15:36'),
(3963, 'en', 'home page', 'FAQ', 'FAQ', '2022-02-26 22:16:12', '2022-02-26 22:16:12'),
(3964, 'en', 'home page', 'FAQ description', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry.', '2022-02-26 22:16:12', '2022-02-26 22:17:33'),
(3965, 'en', 'home page', 'Contact Us', 'Contact Us', '2022-02-26 22:17:02', '2022-02-26 22:17:02'),
(3966, 'en', 'home page', 'Contact Us description', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry.', '2022-02-26 22:17:02', '2022-02-26 22:17:33'),
...
(3970, 'en', 'home page', 'Send', 'Send', '2022-02-26 22:26:10', '2022-02-26 22:26:10'),
(3971, 'en', 'alerts', 'Sending emails is not available right now', 'Sending emails is not available right now', '2022-02-26 22:39:30', '2022-02-26 22:39:30'),
(3972, 'en', 'alerts', 'Error on sending', 'Error on sending', '2022-02-26 23:02:25', '2022-02-26 23:02:25'),
(3973, 'en', 'alerts', 'Your message has been sent successfully', 'Your message has been sent successfully', '2022-02-26 23:04:48', '2022-02-26 23:04:48'),
(3974, 'en', 'blog', 'Read More', 'Read More', '2022-02-26 23:16:32', '2022-02-26 23:16:32'),
(3975, 'en', 'home page', 'View All', 'View All', '2022-02-26 23:18:12', '2022-02-26 23:18:12'),
(3976, 'en', 'home page', 'Find out more answers on our FAQ', 'Find out more answers on our FAQ', '2022-02-26 23:21:20', '2022-02-26 23:21:20'),
...
(4606, 'en', 'general', 'Contact Us', 'Contact Us', '2022-03-04 00:41:35', '2022-03-04 00:41:35'),
...
(4965, 'en', 'checkout', 'Cancel', 'Cancel', '2022-03-09 16:26:15', '2022-03-09 16:26:15'),
...
(4994, 'en', 'user', 'Total Price', 'Total Price', '2022-03-09 19:07:45', '2022-03-09 19:07:45'),
...
(7186, 'en', 'upload zone', 'file is too big max file size: {maxFilesize}MiB.', 'file is too big max file size: {maxFilesize}MiB.', '2022-03-16 16:28:43', '2022-03-21 22:40:24'),
(7187, 'en', 'upload zone', 'Server responded with {statusCode} code.', 'Server responded with {statusCode} code.', '2022-03-16 16:28:43', '2022-03-21 22:40:24'),
(7188, 'en', 'upload zone', 'Drop files here to upload', 'Drop files here to upload', '2022-03-16 16:28:43', '2022-03-21 22:40:24'),
(7189, 'en', 'upload zone', 'Your browser does not support drag and drop file uploads.', 'Your browser does not support drag and drop file uploads.', '2022-03-16 16:28:43', '2022-03-21 22:40:24'),
(7190, 'en', 'upload zone', 'Please use the fallback form below to upload your files like in the olden days.', 'Please use the fallback form below to upload your files like in the olden days.', '2022-03-16 16:28:43', '2022-03-21 22:40:24'),
(7191, 'en', 'upload zone', 'You cannot upload files of this type.', 'You cannot upload files of this type.', '2022-03-16 16:28:43', '2022-03-21 22:40:24'),
(7192, 'en', 'upload zone', 'Cancel upload', 'Cancel upload', '2022-03-16 16:28:43', '2022-03-21 22:40:24'),
(7193, 'en', 'upload zone', 'Are you sure you want to cancel this upload?', 'Are you sure you want to cancel this upload?', '2022-03-16 16:28:43', '2022-03-21 22:40:24'),
(7194, 'en', 'upload zone', 'Remove file', 'Remove file', '2022-03-16 16:28:43', '2022-03-21 22:40:24'),
(7195, 'en', 'upload zone', 'You can not upload any more files.', 'You can not upload any more files.', '2022-03-16 16:28:43', '2022-03-21 22:40:24'),
(7196, 'en', 'upload zone', 'Max size per transfer : {maxTransferSize}.', 'Max size per transfer : {maxTransferSize}.', '2022-03-16 19:27:56', '2022-03-21 22:40:24'),
(7198, 'en', 'upload zone', 'Unavailable storage provider', 'Unavailable storage provider', '2022-03-16 20:44:15', '2022-03-21 22:40:24'),
...
(7201, 'en', 'upload zone', 'File not exists', 'File not exists', '2022-03-18 21:52:51', '2022-03-21 22:40:24'),
...
(7208, 'en', 'upload zone', 'Drop File Here', 'Drop File Here', '2022-03-21 22:10:53', '2022-03-21 22:40:24'),
(7209, 'en', 'upload zone', 'Add your files or folders by drag-and-dropping them on this window 😉', 'Add your files or folders by drag-and-dropping them on this window 😉', '2022-03-21 22:10:53', '2022-03-21 22:40:24'),
(7210, 'en', 'upload zone', 'Send large files fast, easy and secure', 'Send large files fast, easy and secure', '2022-03-21 22:10:53', '2022-03-21 22:40:24'),
(7211, 'en', 'upload zone', 'Transfer your images, videos and heavy documents of up to 20 GB* per transfer', 'Transfer your images, videos and heavy documents of up to 20 GB* per transfer', '2022-03-21 22:10:53', '2022-03-21 22:40:24'),
(7212, 'en', 'upload zone', 'Start', 'Start', '2022-03-21 22:10:53', '2022-03-21 22:40:24'),
(7213, 'en', 'upload zone', 'Click or drag and drop your files here', 'Click or drag and drop your files here', '2022-03-21 22:10:53', '2022-03-21 22:40:24'),
(7214, 'en', 'upload zone', 'Or Click here', 'Or Click here', '2022-03-21 22:10:53', '2022-03-21 22:40:24'),
(7215, 'en', 'upload zone', 'Downloaded files', 'Downloaded files', '2022-03-21 22:10:53', '2022-03-21 22:40:24'),
(7216, 'en', 'upload zone', 'Send files', 'Send files', '2022-03-21 22:10:53', '2022-03-22 16:44:12'),
(7217, 'en', 'upload zone', 'Total transfers', 'Total transfers', '2022-03-21 22:10:53', '2022-03-21 22:40:24'),
(7218, 'en', 'upload zone', 'Create a link', 'Create a link', '2022-03-21 22:10:53', '2022-03-21 22:40:24'),
(7230, 'en', 'upload zone', 'Your Email Address', 'Your Email Address', '2022-03-21 22:15:39', '2022-03-21 22:40:24'),
(7231, 'en', 'upload zone', 'Enter your email address to track your transfer.', 'Enter your email address to track your transfer.', '2022-03-21 22:20:51', '2022-03-21 22:40:24'),
(7232, 'en', 'upload zone', 'Sender name (optional)', 'Sender name (optional)', '2022-03-21 22:20:51', '2022-03-21 22:40:24'),
(7233, 'en', 'upload zone', 'You can provide a sender name to your contacts so they can identify you.', 'You can provide a sender name to your contacts so they can identify you.', '2022-03-21 22:20:51', '2022-03-21 22:40:24'),
(7234, 'en', 'upload zone', 'Send to', 'Send to', '2022-03-21 22:20:51', '2022-03-21 22:40:24'),
(7235, 'en', 'upload zone', 'Type email and press enter', 'Type email and press enter', '2022-03-21 22:20:51', '2022-03-21 22:40:24'),
(7236, 'en', 'upload zone', 'Subject (optional)', 'Subject (optional)', '2022-03-21 22:20:51', '2022-03-21 22:40:24'),
(7237, 'en', 'upload zone', 'You can enter a subject to name your transfer and make it more easily identifiable.', 'You can enter a subject to name your transfer and make it more easily identifiable.', '2022-03-21 22:20:51', '2022-03-21 22:40:24'),
(7238, 'en', 'upload zone', 'Your message (optional)', 'Your message (optional)', '2022-03-21 22:20:51', '2022-03-21 22:40:24'),
(7239, 'en', 'upload zone', 'Custom link (optional)', 'Custom link (optional)', '2022-03-21 22:23:19', '2022-03-21 22:40:24'),
(7240, 'en', 'upload zone', 'Customize your transfer links so your users can identify it more easily.', 'Customize your transfer links so your users can identify it more easily.', '2022-03-21 22:23:19', '2022-03-21 22:40:24'),
(7241, 'en', 'upload zone', 'Password', 'Password', '2022-03-21 22:24:14', '2022-03-21 22:40:24'),
(7243, 'en', 'upload zone', 'Notifications', 'Notifications', '2022-03-21 22:29:00', '2022-03-21 22:40:24'),
(7244, 'en', 'upload zone', 'Notify me when downloaded', 'Notify me when downloaded', '2022-03-21 22:29:00', '2022-03-21 22:40:24'),
(7245, 'en', 'upload zone', 'Notify me when expired', 'Notify me when expired', '2022-03-21 22:29:00', '2022-04-01 01:10:22'),
(7246, 'en', 'upload zone', 'Availability', 'Availability', '2022-03-21 22:29:00', '2022-03-21 22:40:24'),
(7247, 'en', 'upload zone', 'Set expiry date', 'Set expiry date', '2022-03-21 22:29:00', '2022-03-21 22:40:24'),
(7248, 'en', 'upload zone', 'Transfer', 'Transfer', '2022-03-21 22:29:00', '2022-03-21 22:40:24'),
(7249, 'en', 'upload zone', 'Ignore', 'Ignore', '2022-03-21 22:29:00', '2022-03-21 22:40:24'),
(7250, 'en', 'upload zone', 'Validate', 'Validate', '2022-03-21 22:29:00', '2022-03-21 22:40:24'),
(7251, 'en', 'upload zone', 'Add more files', 'Add more files', '2022-03-21 22:29:00', '2022-03-21 22:40:24'),
(7252, 'en', 'upload zone', 'files', 'files', '2022-03-21 22:29:00', '2022-03-21 22:40:24'),
...
(7732, 'en', 'upload zone', 'file', 'file', '2022-03-22 16:51:20', '2022-03-22 16:51:20'),
(8212, 'en', 'upload zone', 'Send to field is invalid', 'Send to field is invalid', '2022-03-22 23:04:30', '2022-03-22 23:04:30'),
(8213, 'en', 'upload zone', 'No files uploaded', 'No files uploaded', '2022-03-22 23:51:59', '2022-03-22 23:51:59'),
(8214, 'en', 'upload zone', 'File error', 'File error', '2022-03-23 00:04:09', '2022-03-23 00:04:09'),
(8215, 'en', 'upload zone', 'The notify on download and expiry feature not available for your subscription', 'The notify on download and expiry feature not available for your subscription', '2022-03-23 18:23:29', '2022-03-23 18:23:29'),
(8216, 'en', 'upload zone', 'Setting expiry date feature not available for your subscription', 'Setting expiry date feature not available for your subscription', '2022-03-23 18:25:19', '2022-03-23 18:25:19'),
(8217, 'en', 'upload zone', 'Setting password feature not available for your subscription', 'Setting password feature not available for your subscription', '2022-03-23 18:26:34', '2022-03-23 18:26:34'),
(8218, 'en', 'upload zone', 'It\'s done!', 'It\'s done!', '2022-03-23 23:48:47', '2022-03-23 23:48:47'),
(8219, 'en', 'upload zone', 'Your transfer download link will be available until {expiry_interval}.', 'Your transfer download link will be available until {expiry_interval}.', '2022-03-23 23:48:47', '2022-03-23 23:48:47'),
(8220, 'en', 'upload zone', 'You can copy the download link, view the content or share it', 'You can copy the download link, view the content or share it', '2022-03-23 23:48:47', '2022-03-23 23:48:47'),
(8221, 'en', 'upload zone', 'Expiry date is invalid', 'Expiry date is invalid', '2022-03-24 00:37:17', '2022-03-24 00:37:17'),
(8222, 'en', 'upload zone', 'Expiry date must be equal or less than {files_duration}', 'Expiry date must be equal or less than {files_duration}', '2022-03-24 00:46:33', '2022-03-24 00:46:33'),
(8223, 'en', 'upload zone', 'Expiry date must be 10 minutes minimum', 'Expiry date must be 10 minutes minimum', '2022-03-24 00:54:48', '2022-03-24 00:54:48'),
(8224, 'en', 'upload zone', 'Copy', 'Copy', '2022-03-24 01:46:06', '2022-03-24 01:46:06'),
(8225, 'en', 'upload zone', 'View my transfer', 'View my transfer', '2022-03-24 01:46:06', '2022-03-24 01:46:06'),
(8226, 'en', 'upload zone', 'New transfer?', 'New transfer?', '2022-03-24 01:46:06', '2022-03-24 01:46:06'),
...
(8232, 'en', 'download', 'Files are ready!', 'Files are ready!', '2022-03-25 19:19:56', '2022-03-25 19:19:56'),
(8233, 'en', 'download', 'Expires on', 'Expires on', '2022-03-25 19:19:56', '2022-03-25 19:19:56'),
(8234, 'en', 'user', 'Copied to clipboard', 'Copied to clipboard', '2022-03-26 00:55:43', '2022-03-26 00:55:43'),
(8236, 'en', 'download', 'Download', 'Download', '2022-03-26 01:36:01', '2022-03-26 01:36:01'),
(8237, 'en', 'download', 'This transfer protected by password', 'This transfer protected by password', '2022-03-26 01:54:21', '2022-03-26 01:54:21'),
(8238, 'en', 'download', 'Password', 'Password', '2022-03-26 01:54:21', '2022-03-26 01:54:21'),
(8239, 'en', 'download', 'Unlock transfer', 'Unlock transfer', '2022-03-26 01:54:21', '2022-03-26 01:54:21'),
(8240, 'en', 'download', 'Transfer not found', 'Transfer not found', '2022-03-26 02:04:32', '2022-03-26 02:04:32'),
(8241, 'en', 'download', 'Incorrect password', 'Incorrect password', '2022-03-26 02:07:36', '2022-03-26 02:07:36'),
(8242, 'en', 'upload zone', 'Failed to upload', 'Failed to upload', '2022-03-26 19:56:48', '2022-03-26 19:56:48'),
(8243, 'en', 'upload zone', 'Transfer error', 'Transfer error', '2022-03-27 00:19:23', '2022-03-27 00:19:23'),
(8244, 'en', 'upload zone', 'Custom link can only contain Letters or Numbers or Dashes', 'Custom link can only contain Letters or Numbers or Dashes', '2022-03-27 02:26:22', '2022-03-27 02:26:22'),
(8245, 'en', 'upload zone', 'Transfer files to one or more recipients', 'Transfer files to one or more recipients', '2022-03-27 02:18:04', '2022-03-27 02:18:04'),
(8246, 'en', 'upload zone', 'Upload files and get download link', 'Upload files and get download link', '2022-03-27 02:18:04', '2022-03-27 02:18:04'),
(8247, 'en', 'upload zone', 'Create a link feature not available for your subscription', 'Create a link feature not available for your subscription', '2022-03-27 03:42:42', '2022-03-27 03:42:42'),
(8248, 'en', 'upload zone', 'Average user rating', 'Average user rating', '2022-03-27 21:25:52', '2022-03-27 21:25:52'),
(8249, 'en', 'upload zone', 'votes', 'votes', '2022-03-27 21:25:52', '2022-03-27 21:25:52'),
(8250, 'en', 'upload zone', 'vote', 'vote', '2022-03-27 21:26:12', '2022-03-27 21:26:12'),
(8251, 'en', 'upload zone', 'Rate {website_name} :', 'Rate {website_name} :', '2022-03-27 21:27:37', '2022-03-27 21:27:37'),
(8252, 'en', 'upload zone', 'You have already rate the service', 'You have already rate the service', '2022-03-27 21:46:58', '2022-03-27 21:46:58'),
(8253, 'en', 'upload zone', 'Invalid rating request', 'Invalid rating request', '2022-03-27 21:49:34', '2022-03-27 21:49:34'),
(8254, 'en', 'upload zone', 'Rating recorded successfully', 'Rating recorded successfully', '2022-03-27 21:52:41', '2022-03-27 21:52:41'),
...
(8367, 'en', 'download', 'Requested file not exists', 'Requested file not exists', '2022-03-31 16:47:20', '2022-03-31 16:47:20'),
(8368, 'en', 'download', 'Unauthorized access', 'Unauthorized access', '2022-03-31 16:52:28', '2022-03-31 16:52:28'),
(8372, 'en', 'download', 'Download all not supported on this transfer', 'Download all not supported on this transfer', '2022-03-31 18:35:17', '2022-03-31 18:35:17'),
(8373, 'en', 'download', 'Download all', 'Download all', '2022-03-31 20:31:47', '2022-03-31 20:31:47'),
(8374, 'en', 'upload zone', 'Storage provider error', 'Storage provider error', '2022-03-31 20:41:44', '2022-03-31 20:41:44'),
...
(8377, 'en', 'download', 'Download file', 'Download file', '2022-03-31 21:19:39', '2022-03-31 21:19:39'),
...
(10046, 'en', 'general', 'bytes', 'bytes', '2022-04-06 02:53:52', '2022-04-06 02:53:52'),
...
(10049, 'en', 'upload zone', 'You cannot use notify when expiry when transfer expiry time is unlimited', 'You cannot use notify when expiry when transfer expiry time is unlimited', '2022-04-08 04:20:25', '2022-04-08 04:20:25');
...
ALTER TABLE `ratings`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `ratings_ip_unique` (`ip`);
