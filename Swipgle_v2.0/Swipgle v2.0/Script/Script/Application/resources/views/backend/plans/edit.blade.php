            ...
            <ul class="custom-list-group list-group list-group-flush">
                    ...
                    <div class="row g-2 align-items-center">
                        ...
                        <div class="col col-lg-4">
                            <input type="text" name="name" class="form-control" value="{{ $plan->name }}" required
                                autofocus placeholder="Enter plan name" />
                        </div>
                    </div>
                </li>
                <li class="list-group-item">
                        ...
                        <div class="col col-lg-4">
                            <div class="input-group">
                                <input id="planPrice" type="text" name="price" class="form-control input-price"
                                    placeholder="0.00" value="{{ price($plan->price, 2) }}" required
                ...
                <li id="loginRequire" class="fadeIn list-group-item {{ $plan->price != 0 ? 'd-none' : '' }}">
                    <div class="row align-items-center">
                        ...
                        <div class="col-4 col-lg-4">
                            <input type="checkbox" name="auth" data-toggle="toggle" data-off="No" data-on="Yes"
                                {{ $plan->auth ? 'checked' : '' }}>
                        </div>
                    </div>
                </li>
                ...
                <li class="list-group-item">
                    <div class="row align-items-center">
                        ...
                        <div class="col-4 col-lg-4">
                            <input type="checkbox" name="transfer_password" data-toggle="toggle" data-off="OFF" data-on="ON"
                ...
                <li class="list-group-item">
                    <div class="row align-items-center">
                        ...
                        <div class="col-4 col-lg-4">
                            <input type="checkbox" name="transfer_notify" data-toggle="toggle" data-off="OFF" data-on="ON"
                ...
                <li class="list-group-item">
                    <div class="row align-items-center">
                        ...
                        <div class="col-4 col-lg-4">
                            <input type="checkbox" name="transfer_expiry" data-toggle="toggle" data-off="OFF" data-on="ON"
                ...
                <li class="list-group-item">
                    <div class="row align-items-center">
                        ...
                        <div class="col-4 col-lg-4">
                            <input type="checkbox" name="transfer_link" data-toggle="toggle" data-off="OFF" data-on="ON"
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col">
                                    <input type="text" name="custom_features[{{ $key }}][name]"
                                        placeholder="Enter name" class="form-control" value="{{ $value->name }}"
                                        required>
                                </div>
                                <div class="col-auto">
