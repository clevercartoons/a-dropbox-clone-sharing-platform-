        ...
        <div class="vironeer-sidebar-links">
            ...
            <div class="vironeer-sidebar-links-cont">
                ...
                <a href="{{ route('admin.ratings.index') }}"
                    class="vironeer-sidebar-link @if (request()->segment(2) == 'ratings') current @endif">
                    <p class="vironeer-sidebar-link-title">
                        <span><i class="fa fa-star"></i>{{ __('Manage Ratings') }}</span>
                        @if ($unreadRatingsCount)
                            <span class="counter">{{ $unreadRatingsCount }}</span>
                        @endif
                    </p>
                </a>
            </div>
