...
@section('content')
    <div class="row g-3 mb-3">
        <div class="col-12 col-lg-6 col-xxl">
            <div class="vironeer-counter-box bg-primary h-100">
                                ...
                                <td>
                                    <div class="text-end">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-sm-end" data-popper-placement="bottom-end">
                                            <li>
                                                <a class="dropdown-item editSubscription"
                                                    data-id="{{ $activeSubscription->id }}" href="#"><i
                                ...
                                <td>
                                    <div class="text-end">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-sm-end" data-popper-placement="bottom-end">
                                            <li>
                                                <a class="dropdown-item editSubscription"
                                                    data-id="{{ $expiredSubscription->id }}" href="#"><i
                                                        class="fa fa-edit me-2"></i>{{ __('Edit') }}</a>
                                            </li>
                                            <li>
                                                <hr class="dropdown-divider" />
                                    ...
                                    <td>
                                        <div class="text-end">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-sm-end"
                                                ...
                                                <li>
                                                    <a class="dropdown-item editSubscription"
                                                        data-id="{{ $canceledSubscription->id }}" href="#"><i
                                                            class="fa fa-edit me-2"></i>{{ __('Edit') }}</a>
                                                </li>
                                                <li>
                                                    <hr class="dropdown-divider" />
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="addModalLabel">{{ __('New Subscription') }}</h5>
                ...
                <div class="modal-body">
                    <form action="{{ route('admin.subscriptions.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            <label class="form-label">{{ __('Plan') }} : <span
                                    class="red">*</span></label>
                            <select name="plan" class="form-select" required>
                                <option value="" selected disabled>{{ __('Choose') }}</option>
                                @foreach ($plans as $plan)
                                    <option value="{{ $plan->id }}" @if (old('plan') == $plan->id) selected @endif>
                                        {{ $plan->name }} ({{ $plan->interval ? __('Yearly') : __('Monthly') }})
                                    </option>
                                @endforeach
                            </select>
                        </div>
                ...
                <div class="modal-body">
                    <form id="editSubscriptionForm" action="" method="POST">
                        ...
                        <div class="mb-3">
                            <label class="form-label">{{ __('Plan') }} : <span
                                    class="red">*</span></label>
                            <select id="subscriptionPlan" name="plan" class="form-select" required>
                                @foreach ($plans as $plan)
                        ...
                        <div class="mb-4">
                            <label class="form-label">{{ __('Expiry at') }} : <span
                                    class="red">*</span></label>
                            <input id="subscriptionExpirtAt" type="datetime-local" name="expiry_at" class="form-control">
                        </div>
