    ...
    <form id="vironeer-submited-form" action="{{ route('admin.settings.general.update') }}" method="POST"
        ...
        <div class="card mb-3">
            ...
            <div class="card-body">
                <div class="row g-3 mb-2">
                    ...
                    <div class="col-lg-6">
                        <label class="form-label">{{ __('Timezone') }} : <span
                                class="red">*</span></label>
            ...
            <div class="card-body">
                <div class="row g-3 mb-2">
                    ...
                    <div class="col-lg-12 col-xl-4">
                        <label class="form-label">{{ __('Spinner button dark color') }} : <span
                                class="red">*</span></label>
                        <div class="vironeer-color-picker input-group">
                            <span class="input-group-text colorpicker-input-addon">
                                <i></i>
                            </span>
                            <input type="text" name="website_uploadbtn_dark_color" class="form-control"
                                value="{{ $settings['website_uploadbtn_dark_color'] }}" required>
                        </div>
                    </div>
                    <div class="col-lg-12 col-xl-4">
                        <label class="form-label">{{ __('Spinner button medium color') }} : <span
                                class="red">*</span></label>
                        <div class="vironeer-color-picker input-group">
                            <span class="input-group-text colorpicker-input-addon">
                                <i></i>
                            </span>
                            <input type="text" name="website_uploadbtn_medium_color" class="form-control"
                                value="{{ $settings['website_uploadbtn_medium_color'] }}" required>
                        </div>
                    </div>
                    <div class="col-lg-12 col-xl-4">
                        <label class="form-label">{{ __('Spinner button light color') }} : <span
                                class="red">*</span></label>
                        <div class="vironeer-color-picker input-group">
                            <span class="input-group-text colorpicker-input-addon">
                                <i></i>
                            </span>
                            <input type="text" name="website_uploadbtn_light_color" class="form-control"
                                value="{{ $settings['website_uploadbtn_light_color'] }}" required>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="card mb-3">
            ...
            <div class="card-body">
                <div class="row g-3 mb-2">
                    ...
                    <div class="col-lg-3 col-xl-3">
                        <label class="form-label">{{ __('Website blog') }} : <span
                                class="red">*</span></label>
                    ...
                    <div class="col-lg-3 col-xl-3">
                        <label class="form-label">{{ __('Contact Form') }} : <span
                                class="red">*</span></label>
        ...
        <div class="row mb-3">
            ...
            <div class="col-lg-6">
                <div class="card">
                    <div class="card-header">
                        {{ __('Home page background') }}</small>
                    </div>
                    <div class="card-body">
                        <div class="form-group mb-3">
                            <div class="vironeer-image-preview-box bg-light">
                                <img id="vironeer-preview-img-5" src="{{ asset($settings['website_home_background']) }}"
                                    width="100%" height="315px">
                            </div>
                        </div>
                        <div class="mb-3">
                            <input id="vironeer-image-targeted-input-5" type="file" name="website_home_background"
                                accept="image/jpg, image/jpeg" class="form-control" hidden>
                            <button data-id="5" type="button"
                                class="vironeer-select-image-button btn btn-secondary btn-lg w-100 mb-2">{{ __('Choose Image') }}</button>
                            <small class="text-muted">
                                {{ __('Supported (JPEG, JPG) Size') }} <strong>2560x1600px.</strong>
                            </small>
                        </div>
                    </div>
                </div>
        ...
        <div class="card">
            <div class="card-header d-flex align-items-center">
                <div class="col col-lg-9">{{ __('Upload zone statistics') }}</div>
                <div class="col col-lg-3">
                    <input type="checkbox" id="statistics-action" name="statistics_action" data-toggle="toggle"
                        data-off="Enter" data-on="Auto count"
                        {{ is_null($settings['statistics_download_files']) &&
                        is_null($settings['statistics_send_files']) &&
                        is_null($settings['statistics_total_transfers'])
                            ? 'checked'
                            : '' }}>
                </div>
            </div>
            <div class="statistics-box card-body">
                <div class="row g-3">
                    <div class="col-lg-4">
                        <label class="form-label">{{ __('Downloaded files') }} : </label>
                        <input type="number" name="statistics_download_files" class="form-control"
                            value="{{ $settings['statistics_download_files'] }}"
                            {{ $settings['statistics_download_files'] ? '' : 'disabled' }} placeholder="0">
                    </div>
                    <div class="col-lg-4">
                        <label class="form-label">{{ __('Send files') }} : </label>
                        <input type="number" name="statistics_send_files" class="form-control"
                            value="{{ $settings['statistics_send_files'] }}"
                            {{ $settings['statistics_send_files'] ? '' : 'disabled' }} placeholder="0">
                    </div>
                    <div class="col-lg-4">
                        <label class="form-label">{{ __('Total transfers') }} : </label>
                        <input type="number" name="statistics_total_transfers" class="form-control"
                            value="{{ $settings['statistics_total_transfers'] }}"
                            {{ $settings['statistics_total_transfers'] ? '' : 'disabled' }} placeholder="0">
                    </div>
                </div>
            </div>
        </div>
