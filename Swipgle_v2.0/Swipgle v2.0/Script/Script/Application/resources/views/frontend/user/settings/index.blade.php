...
@section('content')
    ...
    <div class="modal fade" id="mobileModal" tabindex="-1" aria-labelledby="mobileModalLabel" data-bs-backdrop="static"
                ...
                <form action="{{ route('user.settings.details.mobile.update') }}" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="d-flex justify-content-between">
                            <button type="submit" class="btn btn-primary w-100 me-2">{{ lang('Save', 'user') }}</button>
